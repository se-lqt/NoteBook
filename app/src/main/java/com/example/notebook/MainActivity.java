    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.user_p:
                ...
                Intent intent = new Intent(MainActivity.this, com.example.notebook.AddData.class);
                startActivityForResult(intent,1);
                return true;
            case R.id.write_p:
                //oast.makeText(this, "你点击了“切换”按键！", Toast.LENGTH_SHORT).show();
                Intent intent3 = new Intent(MainActivity.this, com.example.notebook.change.class);
            ...
            case R.id.search_p:
                ...
                查找功能
                 */
                Intent intent2 = new Intent(this, com.example.notebook.Search.class);
                this.startActivity(intent2);
                return true;
            case R.id.favo_p:
                Toast.makeText(this, "你点击了“视图”按键！", Toast.LENGTH_SHORT).show();
                return true;
            default:
